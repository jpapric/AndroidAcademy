...
import com.example.androidacademyapi.R
...
fun ProductListScreen(navController: NavController){
    ...
    ProductListContent(
        ...
        onRetryClick = viewModel::getProductList,
        onAddClick = {
...
fun ProductListContent(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            if (productListUIState is ProductListUIState.Success) {
                FloatingActionButton(
                    onClick = onAddClick
                ) {
                    Icon(
        ...
        when(productListUIState){
            is ProductListUIState.Error -> {
                ErrorStateScreen(
                    ...
                    description = productListUIState.message,
                    actionLabel = "Retry",
...
fun ListItemWithMenu(
    ...
    Box {
        ListItem(
            ...
            leadingContent = {
                Image(
                    painter = painterResource(id = R.drawable.andorid),
                    contentDescription = null,
